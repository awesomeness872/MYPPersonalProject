...
UNREALROOTPATH = /games/UnrealEngine
GAMEPROJECTFILE =/home/paul/Documents/Unreal Projects/RPGProject/RPGProject.uproject
...
TARGETS = \
	...
	RPGProject-Linux-Debug  \
	RPGProject-Linux-DebugGame  \
	RPGProject-Linux-Shipping  \
	RPGProject-Linux-Test  \
	RPGProject \
	RPGProjectEditor-Linux-Debug  \
	RPGProjectEditor-Linux-DebugGame  \
	RPGProjectEditor-Linux-Shipping  \
	RPGProjectEditor-Linux-Test  \
	RPGProjectEditor\
	configure
...
RPGProject-Linux-Debug:
	 $(PROJECTBUILD) RPGProject Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

RPGProject-Linux-DebugGame:
	 $(PROJECTBUILD) RPGProject Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

RPGProject-Linux-Shipping:
	 $(PROJECTBUILD) RPGProject Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

RPGProject-Linux-Test:
	 $(PROJECTBUILD) RPGProject Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

RPGProject:
	 $(PROJECTBUILD) RPGProject Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

RPGProjectEditor-Linux-Debug:
	 $(PROJECTBUILD) RPGProjectEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

RPGProjectEditor-Linux-DebugGame:
	 $(PROJECTBUILD) RPGProjectEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

RPGProjectEditor-Linux-Shipping:
	 $(PROJECTBUILD) RPGProjectEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

RPGProjectEditor-Linux-Test:
	 $(PROJECTBUILD) RPGProjectEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

RPGProjectEditor:
	 $(PROJECTBUILD) RPGProjectEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
